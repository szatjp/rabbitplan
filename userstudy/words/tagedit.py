...
class WordClassDetail(DetailView):
    model = WordClass
    template_name = 'dictedit/wordview.html'
    fields = ['fword','fpronunciation','fwordclass']

class WordClassUpdate(UpdateView):
    model = WordClass
    template_name = 'dictedit/wordedit.html'
    fields = ['fword','fpronunciation','fwordclass']
    def get_context_data(self, **kwargs):
        context = super(WordClassUpdate, self).get_context_data(**kwargs)
        return context

class WordClassDelete(DeleteView):
    model = WordClass
